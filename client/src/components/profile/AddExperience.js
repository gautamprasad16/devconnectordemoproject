...
const AddExperience = ({ addExperience, history }) => {
    ...
    const { company, title, location, fromDate, toDate, current, description } = formData;
    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={e => onSubmit(e)} >
                ...
                <div className="form-group">
                    <h4>To Date</h4>
                    <input type="date" name="toDate" value={toDate} onChange={e => onChange(e)} disabled={toDateDisabled ? 'disabled' : ''} />
                </div>
                <div className="form-group">
                    <textarea
                        name="description"
